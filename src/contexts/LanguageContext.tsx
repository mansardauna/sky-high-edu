...
const translations: Translations = {
  ...
  "mission_description": { en: "To provide quality Islamic and Modern education that develops students into well-rounded individuals who are academically excellent, morally upright, and spiritually grounded, prepared to contribute positively to society while maintaining their Islamic values.", ar: "توفير تعليم إسلامي عالي الجودة يطور الطلاب ليصبحوا أفراداً متكاملين متفوقين أكاديمياً، مستقيمين أخلاقياً، وراسخين روحياً، مستعدين للمساهمة إيجابياً في المجتمع مع الحفاظ على قيمهم الإسلامية." },
  ...
  "academic_rigor_desc": { en: "Maintaining high standards in both Islamic and Modern education", ar: "الحفاظ على معايير عالية في كل من التعليم الإسلامي الحديثة" },
